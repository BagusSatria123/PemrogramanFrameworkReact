...
class BlogPost extends Component {
  ...
  handleTombolSimpan = (data) => {
    ...
    if (
      this.state.insertProduk["namaproduk"] !== "" &&
      this.state.insertProduk["namaproduk"] !== undefined
    ) {
    ...
    return (
      <div className="post-artikel">
        ...
        {this.state.listProduk.map((artikel) => {
          return (
            <Post
              key={artikel.idProduk}
              id={artikel.id}
              namaproduk={artikel.namaproduk}
              harga={artikel.harga}
              gambar={artikel.gambar}
              stock={artikel.stock}
              qty={artikel.qty}
              idArtikel={artikel.id}
              tambahArtikel={this.handleTombolSimpan}
            />
          );
        })}
      </div>
