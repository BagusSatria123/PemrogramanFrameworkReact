            ...
            <div className="row animated fadeIn">
                <div className="col-md-4 stretch-card grid-margin">
                    ...
                    <div className="card-body">
                        ...
                        <h4 className="font-weight-normal mb-3">Total Peserta vaksin <i className="mdi mdi-chart-line mdi-24px float-right"></i>
                        </h4>
                ...
                <div className="col-md-4 stretch-card grid-margin">
                    ...
                    <div className="card-body">
                        <img src="/assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle-image" />
                        <h4 className="font-weight-normal mb-3">Peserta vaksin Baru Minggu Ini<i className="mdi mdi-calendar-text mdi-24px float-right"></i>
                        </h4>
                ...
                <div className="col-md-4 stretch-card grid-margin">
                    ...
                    <div className="card-body">
                        <img src="/assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle-image" />
                        <h4 className="font-weight-normal mb-3">Peserta vaksin Baru Bulan Ini <i className="mdi mdi-calendar-multiple-check mdi-24px float-right"></i>
                        </h4>
