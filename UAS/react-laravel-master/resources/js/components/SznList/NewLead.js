...
function NewLead(props) {
    ...
    useEffect(() => {
        document.title = 'Input Data Peserta vaksin';

        props.setActiveComponentProp('Input Data Peserta vaksin');
    }, []);
                            ...
                            >
                                <form className="new-lead-form border" onSubmit={onSubmitHandle}>
                                    ...
                                    <div className="form-group">
                                        <ul className="nav nav-tabs nav-pills c--nav-pills nav-justified">
                                            <li className="nav-item">
                                                <span className="nav-link btn btn-gradient-info btn-block active">Input Data Peserta vaksin</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="form-group text-center">
                                        <button type="submit" className="btn btn-gradient-info btn-md mr-2">Save</button>
